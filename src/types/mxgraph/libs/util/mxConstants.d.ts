declare module 'mxgraph' {
  ...
  class mxConstants {
     ...
     *
     */
    static CUSTOM_TOOLTIP: 'tooltip';
    static CUSTOM_TOOLTIP_STATIC_CLASS:'customTooltipStaticClass';
    /**
     *
     */
    static CUSTOM_NODESET_JUMP: 'customNodesetJump';
    /**
     * cell 里左侧图标
     */
    static CUSTOM_OVERLY_ICON: 'customOverlyIcon';
    /**
     * cell 类型唯一值，对应svgConst.ts里的key值
     */
    static CUSTOM_CELL_UNIQUE_KEY: 'customCellUniqueKey';
    /**
     * 存储的是bpmn节点的属性及其值
     */
    static CUSTOM_BPMN_DATA_KEY: 'customBpmnDataKey';
    /**
     * 存储的是xml标签
     */
    static CUSTOM_BPMN_LABEL: 'customBpmnLabel';
    /**
     * 存储的是节点的链接信息，out in doc等
     */
    static CUSTOM_BPMN_NODE_CHILD: 'customBpmnNodeChild';
    /**
     * 换行符
     */
    static CUSTOM_EOL:'\r\n';
     ...
     * bpmn 线条信息
     */
    static CUSTOM_BPMN_EDGE_INFOS: 'customBpmnEdgeInfos';
    /**
     * bpmn 流程信息
     */
    static CUSTOM_BPMN_PROCESS_INFO: 'customBpmnProcessInfo';
    /**
     * graph 创建成功后
     */
    static CUSTOM_GRAPH_CREATED: 'customGraphCreated';
  }
