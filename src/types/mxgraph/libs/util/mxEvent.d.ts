declare module 'mxgraph' {
  ...
  class mxEvent {
    ...
    /**
     * Specifies the event name for tooltip trigger.
     */
    static CUSTOM_NODESET_TOOLTIP: 'customNodesetTooltip';
    static CUSTOM_NODESET_JUMP_CLICK: 'customNodesetJumpClick'
    static CUSTOM_CLEAR_ALL_ICON: 'customClearAllIcon'
  }
}
